...
export const HOTEL = {
  ...
  address: "220 BP 40 Anié, Togo",
  locationHint: "Derrière le grand marché d'Anié",
  phone: "+228 98 43 90 90",
  secondaryPhone: "+228 92 56 60 60",
  whatsapp: "22890123456",
  email: "hotelchevaldor@gmail.com",
