...
const dict = {
  fr: {
    nav: { home: "Accueil", rooms: "Chambres", book: "Réserver", restaurant: "Restaurant", gallery: "Galerie", services: "Services", experiences: "Expériences", offers: "Offres", about: "À propos", blog: "Blog", faq: "FAQ", contact: "Contact", compare: "Comparer", events: "Événements", guide: "Guide Lomé" },
  ...
  en: {
    nav: { home: "Home", rooms: "Rooms", book: "Book", restaurant: "Restaurant", gallery: "Gallery", services: "Services", experiences: "Experiences", offers: "Offers", about: "About", blog: "Blog", faq: "FAQ", contact: "Contact", compare: "Compare", events: "Events", guide: "Lomé Guide" },
