...
import {
  fetchEventBookings, saveEventBooking, setEventStatus, EVENT_TYPES,
...
function AdminEvents() {
  ...
  return (
    <div className="p-6 lg:p-10 space-y-8">
      ...
      >
        <Button variant="hero" onClick={() => setShowForm((s) => !s)}><Plus className="mr-1 size-4" />Nouvel événement</Button>
      </AdminPageHeader>
