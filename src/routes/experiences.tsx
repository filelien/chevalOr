...
export const Route = createFileRoute("/experiences")({
  ...
  component: () => (
    <SiteShell>
      <PageHero image={hero} label="Expériences" title="Moments inoubliables" subtitle="Inspiré de Six Senses et Belmond — découvrez le Togo autrement." />
            ...
            <Reveal key={e.title}>
              <div className="overflow-hidden rounded-xl bg-card shadow-elegant">
                ...
                <div className="p-6">
                  ...
                  <Button variant="goldOutline" className="mt-4" asChild><Link to="/contact">Réserver l'expérience</Link></Button>
                </div>
              </div>
            </Reveal>
          ))}
