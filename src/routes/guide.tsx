...
import { GUIDE_ANIE, HOTEL } from "@/lib/content";
  ...
  component: () => (
    <SiteShell>
      <PageHero
        image={hero}
        label="Tourisme"
        title="Découvrir Anié & la région centrale"
        subtitle="Traditions, hospitalité et patrimoine au cœur du Togo."
      />
      <section className="mx-auto max-w-4xl px-6 py-20">
        <div className="mb-10 rounded-xl bg-secondary/50 p-6">
          <p className="text-sm">
            <strong>Anié</strong> est une ville paisible au centre du Togo, idéale pour découvrir l'authenticité togolaise tout en restant connecté aux principales villes du pays.
          </p>
